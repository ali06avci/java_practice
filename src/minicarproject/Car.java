package minicarproject;
	/*
	 ...
	 Q3) Can we create objects from abstract classes? No, because by objects we can reach methods do not have body, we get error.
	 ...
	 Q5) Constructors are to create objects. If we can not create object from abstract class,
	 	...
	 	ii) to assign values to instance variables using super constructor call with parameter
	 		when create an object from concrete child class
